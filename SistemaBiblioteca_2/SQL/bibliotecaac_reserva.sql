...
CREATE TABLE `reserva` (
  ...
  CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`Matrícula_leitor`) REFERENCES `leitor` (`Matrícula_leitor`),
  CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`cod_tomb`) REFERENCES `item` (`cod_tomb`),
  CONSTRAINT `reserva_ibfk_3` FOREIGN KEY (`Matrícula_bib`) REFERENCES `bibliotecario` (`Matrícula_bib`)
